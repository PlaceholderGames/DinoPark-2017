...
struct v2f {
	...
	float3 ref;
	#endif
	float2 bumpuv[2] : TEXCOORD0; // Fix for missing input semantic
	float4 viewDirZ : TEXTCOORD2; // Fix for missing input semantic
	// from https://answers.unity.com/questions/202671/combining-two-shaders-into-one.html
}; 
