...
public class IslandWater : MonoBehaviour
{
    new public Renderer renderer; // Unity 4 to 5 fix ***
    new public Camera camera;
    // tip from https://answers.unity.com/questions/922642/unityenginecomponent-does-not-contain-definition.html
    // and https://forum.unity.com/threads/error-warning-cs0108-tile-renderer-hides-inherited-member.93695/
	...
	private void CreateWaterObjects( Camera currentCamera, out Camera reflectionCamera, out Camera refractionCamera )
	{
		...
		if( mode >= WaterMode.Reflective )
		{
			...
			if( !reflectionCamera ) // catch both not-in-dictionary and in-dictionary-but-deleted-GO
			{
				...
				reflectionCamera = go.GetComponent<Camera>(); //was go.camera; now fixed ***
		...
		if( mode >= WaterMode.Refractive )
		{
			...
			if( !refractionCamera ) // catch both not-in-dictionary and in-dictionary-but-deleted-GO
			{
				...
				refractionCamera = go.GetComponent<Camera>(); //was go.camera; now fixed ***
