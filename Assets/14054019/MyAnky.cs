...
public class MyAnky : MonoBehaviour
{
    ...
    public float hunger = 100, thirst = 69, health = 100;  // Sets values of the hunger, thirst and health
    ...
    public float maxSpeed = 1;              // Max speed is  set to 1
    public float maxAccel = 3;              // Acceleration is set to 3
