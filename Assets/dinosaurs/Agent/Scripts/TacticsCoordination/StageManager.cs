...
public class StageManager : MonoBehaviour
{
    ...
    public bool GrantSlot(int circleId, enemyDino enemy)
    {
        return circleDic[circleId].AddenemyDino(enemy.gameObject);
    }

    public void ReleaseSlot(int circleId, enemyDino enemy)
    {
        circleDic[circleId].RemoveenemyDino(enemy.gameObject);
    }
